...
export const WeatherContextProvider= ({children}) => {
    ...
    const [latitude, setLatitude] = useState ("36.20");
    const [longitude, setLongitude] = useState ("36.16");
    ...
    useEffect(() => {
        ...
        fetch(
            `https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&daily=weathercode,temperature_2m_min,temperature_2m_max&timezone=auto`
        )
